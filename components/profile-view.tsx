...
export function ProfileView() {
  ...
  return (
    <main className="relative min-h-dvh bg-[#e8e9e8] dark:bg-[#16241f] px-5 pb-32 pt-10 text-[#22393c] dark:text-[#f4f1ea] sm:px-8 transition-colors duration-300">
      ...
      <div className="relative mx-auto w-full max-w-md">
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-xs leading-relaxed text-[#22393c]/80 dark:text-[#f4f1ea]/80">
        ...
        <motion.button
          ...
          className="w-full mb-6 glass-button glass-neutral rounded-2xl p-3 flex items-center justify-center gap-2 text-sm font-semibold text-[#22393c] dark:text-[#f4f1ea] transition-transform hover:scale-[1.02]"
        >
        ...
        >
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
            {projects.length > 0 ? projects.map((project) => (
              ...
              <div className="glass-button glass-neutral flex-shrink-0 w-32 rounded-2xl p-3 text-center">
                <p className="text-xs text-[#668184]">No projects yet</p>
              </div>
            )}
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="space-y-3">
            {connections.length > 0 ? connections.map((person) => (
              ...
              <div className="glass-button glass-neutral rounded-2xl p-4 text-center">
                <p className="text-xs text-[#668184]">No connections yet. Explore to find teammates!</p>
              </div>
            )}
          </div>
        </motion.section>
        ...
        >
          ...
          <button 
            ...
            className="glass-button glass-neutral flex w-full items-center justify-between rounded-2xl p-4 transition-transform hover:scale-[1.02]"
          >
      ...
      {/* Edit Profile Modal */}
      {isEditing && <EditProfileModal onClose={() => setIsEditing(false)} currentProfile={profile} currentSkills={skills} />}
    </main>
  )
}
